export const modalClasses = {
  ...
  card:
    'bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-[fadeScaleIn_0.2s_ease-out]',
  sizes: {
    sm: 'w-full max-w-sm',
    md: 'w-full max-w-md',
    lg: 'w-full max-w-lg',
  ...
  // Header
  header:
    'flex items-start justify-between gap-4 px-6 pt-6 pb-4 border-b border-slate-100',
  title: 'text-lg font-black text-slate-900 leading-tight',
