export const dateRangePickerClasses = {
  ...
  dayButtonInRange: 'bg-primary/10 text-slate-900 hover:bg-primary/20 rounded-none',
  dayButtonRangeStart: 'rounded-r-none',
  dayButtonRangeEnd: 'rounded-l-none',
  dayButtonDisabled: 'text-slate-300 cursor-not-allowed hover:bg-transparent',
  dayButtonOutside: 'text-slate-300',
  footer: 'mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-xs',
  footerText: 'font-medium text-slate-600',
  footerClear: 'font-black text-slate-500 hover:text-slate-800 transition-colors',
};
