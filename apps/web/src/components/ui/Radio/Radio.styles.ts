export const radioClasses = {
  ...
  inputWrapper:
    'relative shrink-0 w-5 h-5 rounded-full border-2 border-slate-300 bg-white transition-colors duration-200 flex items-center justify-center',
  ...
  input: 'sr-only',
  dot: 'w-2.5 h-2.5 rounded-full bg-primary absolute transition-opacity duration-200',
