...
export const ACTION_SEVERITY_MAP: Record<AuditAction, AuditSeverity> = {
  ...
  TRABAJADOR_CREADO: 'INFO',
  TRABAJADOR_ACTUALIZADO: 'INFO',
  TRABAJADOR_ELIMINADO: 'WARNING',
  TRABAJADOR_LIQUIDADO: 'WARNING',
  BITACORA_RENTA_CREADA: 'INFO',
  BITACORA_RENTA_ACTUALIZADA: 'INFO',
  BITACORA_RENTA_ELIMINADA: 'WARNING',
