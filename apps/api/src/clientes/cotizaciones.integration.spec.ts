/**
 * Integration tests for CotizacionesService audit logging — real DB, no mocks.
 *
 * Verifies that crear una cotización escribe el audit correcto en
 * `registro_auditoria`: COTIZACION_CREADA.
 *
